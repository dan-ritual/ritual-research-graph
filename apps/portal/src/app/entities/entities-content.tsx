...
export function EntitiesContent() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="font-mono text-sm font-semibold uppercase tracking-[0.12em] text-[#3B5FE6] pb-4 mb-6 border-b border-dotted border-[rgba(59,95,230,0.3)]">
          Entities
        </h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <EntityTypeFilter value={typeFilter} onChange={setTypeFilter} />
        <select
          value={sortBy}
          onChange={(e) => setSortBy(e.target.value)}
          className="px-3 py-2 border border-[rgba(0,0,0,0.12)] bg-white font-mono text-xs uppercase tracking-[0.05em] focus:outline-none focus:ring-2 focus:ring-[#3B5FE6]/20"
        >
